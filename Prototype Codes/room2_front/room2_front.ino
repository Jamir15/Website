...
void sendAHT() {
  ...
  String url = "https://firestore.googleapis.com/v1/projects/" + String(projectID) +
               "/databases/(default)/documents/sensorData/room2_front?key=" + String(apiKey);
...
void sendThermal() {
  ...
  HTTPClient http;
  String url = "https://firestore.googleapis.com/v1/projects/" + String(projectID) +
               "/databases/(default)/documents/thermalRooms/room2?key=" + String(apiKey);
